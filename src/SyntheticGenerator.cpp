...
void SyntheticGenerator::setChromosome(const std::string &chr, int length_bp) {
  chr_name = chr;
  chr_length_bp = length_bp;
}

void SyntheticGenerator::setResolution(int bp_per_bead) {
  resolution_bp = bp_per_bead;
}

void SyntheticGenerator::setNumLoops(int n) { num_loops = n; }

void SyntheticGenerator::setEnsembleSize(int n) { ensemble_size = n; }

void SyntheticGenerator::setSegmentSize(int bp) { segment_size_bp = bp; }

void SyntheticGenerator::setOutputDir(const std::string &dir) {
  output_dir = dir;
}

void SyntheticGenerator::setLabel(const std::string &lbl) { label = lbl; }

const Chromosome &SyntheticGenerator::getGroundTruth() const {
  return ground_truth;
}

const Heatmap &SyntheticGenerator::getContactMap() const {
  return contact_map;
}

bool SyntheticGenerator::sameSegment(int bead_a, int bead_b) const {
...
void SyntheticGenerator::generate() {
...
void SyntheticGenerator::placeAnchors(int num_beads) {
...
void SyntheticGenerator::generateLoops(int /*num_beads*/) {
  loop_pairs.clear();
...
std::vector<vector3> SyntheticGenerator::generateRandomPolymer(int num_beads) {
...
void SyntheticGenerator::relaxWithLoops(std::vector<vector3> &positions,
                                        int steps, float dt) {
...
void SyntheticGenerator::generatePolymerEnsemble(int num_beads) {
...
void SyntheticGenerator::writeAnchorsFile() {
...
void SyntheticGenerator::writeClustersFile() {
...
void SyntheticGenerator::writeSingletonsFile(int num_beads) {
...
void SyntheticGenerator::writeSegmentSplit() {
...
void SyntheticGenerator::writeCentromeres() {
...
void SyntheticGenerator::writeConfigINI() {
...
void SyntheticGenerator::writeGroundTruth() {
...
int SyntheticGenerator::poissonSample(float lambda) {
  if (lambda <= 0.0f)
    return 0;
  if (lambda > 30.0f) {
