...
GenomeReconstructor::GenomeReconstructor() : overlap_threshold_(2.0) {}

void GenomeReconstructor::setOverlapThreshold(double threshold) {
    overlap_threshold_ = threshold;
}

void GenomeReconstructor::analyze(HierarchicalChromosome& hc, int level) {
    territories_.clear();
    pairs_.clear();
...
void GenomeReconstructor::writeReport(const std::string& outdir, const std::string& label) {
...
const std::vector<ChromosomeTerritory>& GenomeReconstructor::getTerritories() const {
    return territories_;
}

const std::vector<TerritoryPair>& GenomeReconstructor::getPairs() const {
    return pairs_;
}
